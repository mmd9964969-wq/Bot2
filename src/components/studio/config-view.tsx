...
export function ConfigView() {
  ...
  return <div className="grid gap-4">
    <Panel>
      <PanelTitle kicker={fa ? "فازها" : "Phases"} title={fa ? "دو فاز فعال ربات" : "Two live phases in the bot"} hint={fa ? "فقط دو فاز فعال ربات در این بخش کنترل می‌شوند." : "Only the two active bot phases are controlled here."} />
