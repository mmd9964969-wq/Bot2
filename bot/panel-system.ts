...
async function customerCallback(pool:Pool,cb:TgCallback,ownerIds:string[]){
  ...
  if(data.startsWith("cl:")){
    ...
    const labels:any={
      ...
      normal_web_app:"وب اپ",normal_reply:"ریپلای",normal_edit:"ویرایش",normal_mention:"منشن",normal_bot:"ربات",
      media_photo:"عکس",media_video:"ویدیو",media_audio:"موزیک",media_animation:"گیف",media_sticker:"استیکر",
      ...
      attack_caps:"کنترل CAPS",attack_link_burst:"ضد حمله لینک",attack_media_burst:"ضد حمله رسانه",
